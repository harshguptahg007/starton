...
public class Shoes extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent i = new Intent(Shoes.this, CustomerFront.class);
        startActivity(i);
        finish();
//        super.onBackPressed();
    }

    int[] img = {R.drawable.shoes1, R.drawable.shoes2, R.drawable.shoes3, R.drawable.shoes4};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = res.getStringArray(R.array.Titlesh);
        discription = res.getStringArray(R.array.discriptionsh);
...
class FlipBoxshoe extends ArrayAdapter<String> {
    Context context;
    String[] title;
    String[] discription;
    String[] Qty;
    ...
    public FlipBoxshoe(Context context, String[] title, String[] discription, String[] Qty, int[] img) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View row = inflater.inflate(R.layout.custom_shoes, parent, false);
